...
def checkOptions(options):
    ...
    if options.format == 'Auto':
        if options.profile in image.ProfileData.ProfilesKindleMOBI.keys():
            options.format = 'MOBI'
        elif options.profile in image.ProfileData.ProfilesEPUB.keys():
            options.format = 'EPUB'
        elif options.profile in image.ProfileData.ProfilesKindleCBZ.keys():
            options.format = 'CBZ'
